...
public class Player : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //PlayerPrefs.SetInt("MaxScore", 1234);
    ...
    void Attack()
    {
        ...
        if(fDown && isFireReady && !isDodge && !isReload && !isShop && !isDead)
        {
            equipWeapon.Use();
    ...
    void Reload()
    {
        ...
        if(rDown && !isJump && !isDodge && isFireReady && !isReload && !isDead)
        {
